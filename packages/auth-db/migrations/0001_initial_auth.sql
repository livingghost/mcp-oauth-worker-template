-- Auth schema migration 0001.
-- Clean-state schema for the first release.
-- The TypeScript migration runner uses the equivalent statements in src/migrations.ts.
